  ...
  reminderList.innerHTML = reminders.map(({ prospect, index, days }) => `
    <article class="reminder-item ${days <= 0 ? "reminder-due" : ""}">
      ...
      <div class="reminder-actions">
        ...
        ${prospect.stage === "Sequence" ? `<button class="secondary-button" type="button" data-action="sequence-email-sent" data-index="${index}" title="Mark sequence email sent">Email</button>` : ""}
        ${prospect.stage === "Sequence" ? `<button class="secondary-button" type="button" data-action="sequence-linkedin-sent" data-index="${index}" title="Mark LinkedIn connection sent">LinkedIn</button>` : ""}
        ${prospect.stage === "Sequence" ? `<button class="secondary-button" type="button" data-action="sequence-plan-call" data-index="${index}" title="Move to call stage and schedule tomorrow">Call</button>` : ""}
