...
const checks = [
  ["sync group has priority class", html.includes('class="setup-action-group setup-action-group-primary" role="group" aria-label="CRM sync actions"')],
  ["cleanup group has maintenance class", html.includes('class="setup-action-group setup-action-group-maintenance" role="group" aria-label="CRM cleanup actions"')],
