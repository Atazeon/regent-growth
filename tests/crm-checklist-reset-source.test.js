...
const checks = [
  ["reset button exists", html.includes('<button id="resetCrmChecklistButton" class="secondary-button" type="button" title="Clear saved CRM checklist progress" aria-label="Clear saved CRM checklist progress">Reset</button>')],
