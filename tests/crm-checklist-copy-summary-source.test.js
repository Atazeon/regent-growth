...
const checks = [
  ["copy button exists", html.includes('<button id="copyCrmChecklistButton" class="secondary-button" type="button" title="Copy CRM checklist summary" aria-label="Copy CRM checklist summary">Copy checklist</button>')],
