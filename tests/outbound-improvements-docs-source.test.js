...
const checks = [
  ...
  ["plan mentions queue statuses", plan.includes("outcome-driven fix queue with open/in-progress/resolved statuses")],
  ["plan next triage", plan.includes("- Improvement queue triage")]
];
