...
const checks = [
  ["progress label complete state exists", app.includes('? "CRM checklist complete"')],
  ["progress label partial state exists", app.includes(': `${completed} of ${inputs.length} CRM checklist items complete (${completionPercent}%)`;')],
