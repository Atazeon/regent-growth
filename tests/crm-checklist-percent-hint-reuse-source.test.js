...
const checks = [
  ["progress label includes complete state", app.includes('? "CRM checklist complete"')],
  ["progress label includes percent", app.includes(': `${completed} of ${inputs.length} CRM checklist items complete (${completionPercent}%)`;')],
