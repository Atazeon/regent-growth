...
const checks = [
  ...
  ["crm json copy uses helper", app.includes("await copyTextWithFallback(JSON.stringify(getCrmStatusSummaryRecord(), null, 2));")],
  ...
  ["crm json fallback status", app.includes("CRM sync summary JSON selected and copied.")]
];
