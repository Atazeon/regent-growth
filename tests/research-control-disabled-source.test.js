...
const checks = [
  ...
  ["json export button controlled", helperBody.includes("exportResearchJsonButton.disabled = disabled;")],
  ["json copy button controlled", helperBody.includes("copyResearchJsonButton.disabled = disabled;")],
