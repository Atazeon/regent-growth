...
const checks = [
  ...
  ["plan tracks maintenance next", plan.includes("- Product maintenance and real-user feedback pass") || plan.includes("- Post-launch usability improvements") || plan.includes("- First real outbound session feedback") || plan.includes("- Second outbound session refinements") || plan.includes("- Live outbound run outcomes") || plan.includes("- Outcome-driven product fixes") || plan.includes("- Improvement queue triage")]
];
